...
- [Matter Occupancy Sensor](projects/matter-ld2450/) builds on that backend to publish an HLK-LD2450 radar as a Matter occupancy sensor, and serves its own dashboard from the board.
