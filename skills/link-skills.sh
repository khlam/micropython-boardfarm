#!/usr/bin/env bash
# Link every skills/<name>/SKILL.md into the directories the agents scan —
# .claude/skills (Claude Code) and .agents/skills (Codex), where a missing skill
# is silently invisible — and enforce the 600-word SKILL.md / AGENTS.md cap.
#
