...
The Gregorian calendar math the conversion rests on — leap years, month lengths,
weekday, and the epoch day count — is public too, since a caller that has already
set an RTC still needs it to compare two dates.
