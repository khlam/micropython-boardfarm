...
class EndpointType:
    ...
    OCCUPANCY_SENSOR = 3
    ON_OFF_PLUG_IN_UNIT = 4
    OCCUPANCY_SENSOR_ULTRASONIC = 5
...
SCHEMAS = {
    ...
    EndpointType.ON_OFF_PLUG_IN_UNIT: _BASE_SCHEMA,
    EndpointType.OCCUPANCY_SENSOR_ULTRASONIC: _OCCUPANCY_SCHEMA,
}
