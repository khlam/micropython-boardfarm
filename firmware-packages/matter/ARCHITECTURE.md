...
| `src/endpoint_schema.cpp` | the on/off light, dimmable, extended-colour, occupancy-sensor, and on/off plug-in-unit endpoint configs handed to ESP-Matter |
...
sequenceDiagram
    ...
    st->>esp: endpoint_schema.cpp — on_off_light / dimmable_light / extended_color_light / occupancy_sensor / on_off_plug_in_unit create
