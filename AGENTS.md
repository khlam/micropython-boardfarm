...
| LED strip driver | `firmware-packages/ws2812b/ws2812b/` | `strip.py` — `Strip(count, pin=)` NeoPixel driver on a caller-wired data pin; `effects.py` — rainbow/hue/breathe/fade frame generators |
